...
export const APPRAISAL_RESULTS = [
  {
    ...
    tag: "事故車",
    area: "神奈川県",
    carName: "黒・7人乗りミニバン（大破）",
    image: "/assets/assessments/damaged_black_minivan.jpg",
    year: "2010年式",
    distanceLabel: "走行距離",
    mileage: "13万km",
    expect: "0円",
    ...
    upAmount: "28",
    review:
      "正面が大きく潰れて廃車だと思っていましたが、きちんと金額が付きました。引き取りもスムーズでした。",
    reviewer: "S様",
  },
  {
    id: "accident-hatch",
    tag: "事故車",
    area: "東京都",
    carName: "コンパクトハッチバック（事故車）",
    image: "/assets/assessments/damaged_accident_hatch.jpg",
    year: "2012年式",
    distanceLabel: "走行距離",
    mileage: "9.8万km",
    expect: "0円",
    ...
    upAmount: "18",
    review:
      "側面の損傷が大きくて値段が付かないと思っていましたが、査定してもらえました。対応も丁寧でした。",
    reviewer: "M様",
  },
  {
    id: "old-kei",
    ...
    area: "埼玉県",
    carName: "軽自動車（古い車両）",
    image: "/assets/assessments/damaged_kei.jpg",
    year: "2004年式",
    distanceLabel: "走行距離",
    mileage: "18万km",
    expect: "0円",
    ...
    upAmount: "5",
    review:
      "錆やへこみが多くて諦めていましたが、査定してもらえました。廃車の相談も一緒にできて助かりました。",
    reviewer: "K様",
  },
  {
    id: "elf",
    ...
    upAmount: "90",
    review:
      "法人車両でしたが、現場の都合に合わせて対応してもらえ、希望を上回る金額で売却できました。",
    reviewer: "法人・T様",
  },
  {
    id: "excavator",
    ...
    upAmount: "45",
    review:
      "重機は初めてでしたが、仕様表の見方まで教えてもらい、納得のいく査定でした。",
    reviewer: "土木業・Y様",
  },
];
...
export const APPEALS = [
  {
    ...
    body:
      "乗用車はもちろん、トラック・重機まで。状態や年式を丁寧に確認し、Le Motorが直接査定・買取に向き合います。国内販売や資源としての活用も含め、できる限り価値が付く形をご提案します。",
    okVisual: {
      image: "/assets/icons/appeal-ok-car.png",
      bubbles: ["10万km\n以上", "事故\n水没車", "故障車"],
      title: "どんな状態でもOK！",
      note:
        "古い車や走行距離の多い車両、他店で断られた車も、まずはお気軽にご相談ください。",
    },
  },
  {
    no: 2,
    ...
    body:
      "査定からご契約まで、来店は一切不要。売却や廃車が初めての方でも、電話で楽々対応が可能です。査定額に納得いただけない場合は売却しなくても問題ありません。",
  },
  {
    no: 3,
    title: "査定依頼は完全無料！",
...
export const FAQS = [
  {
    q: "Le Motorの査定の特長は？",
    a: "一括査定ではなく、Le Motorが直接対応します。お問い合わせいただいた車両の状態を丁寧に確認し、国内販売・海外需要も踏まえて「極力買取価格が付く」形でご提案します。",
  },
  {
    q: "故障・不動車も買取は可能ですか？",
